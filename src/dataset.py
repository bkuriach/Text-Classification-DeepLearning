...
class SentimentDataset:
    ...
    def load_data(self):
        with open('/home/binil/Projects/Sessions/TextClassification/input/reviews.txt', 'r') as f:
            self.reviews = f.read()
        with open('/home/binil/Projects/Sessions/TextClassification/input/labels.txt', 'r') as f:
            self.labels = f.read()
